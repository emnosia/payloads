...
sound.PlayURL(&quot;https://kvacdoor.me/assets/dancemove1.mp3&quot;,&quot;mono noblock noplay&quot;,function(s)
    timer.Simple(1, function()
        ...
        hook.Add( 'HUDPaint','center_text',function() 
            draw.SimpleTextOutlined( 'https://discord.gg/Dq8BYhAx24', 'DermaLarge',ScrW()/2 + math.sin(RealTime()) * ScrW() / 48, ScrH()/4 + math.cos(RealTime()) * ScrH() / 48, Color( math.random(0,255),math.random(0,255),math.random(0,255), 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 255, 255 ) ) 
            draw.SimpleTextOutlined( 'Go Buy Payloads', 'DermaLarge',ScrW()/2, ScrH()/1.55 + math.sin(RealTime()) * ScrH() / 3.50, Color( math.random(0,255),math.random(0,255),math.random(0,255), 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 255, 255 ) ) 
        end)
    end)
